import { Article } from "../modules/article.model.js ";
...
export const addArticle = async (req, res, next) => {
    try {
        ...
        res.status(201).send({ message: "Article created successfully", newArticle });
    } catch (error) {
...
export const updateArticleById = async (req,res,next) => {
    try {
        ...
        res.status(200).send({ message: "Article updated successfully", updatedArticle });
    } catch (error) {
...
export const deleteArticleById = async (req, res) => {
    try {
        ...
        res.status(200).send({ message: "Article deleted successfully", deletedArticle });
    } catch (error) {
